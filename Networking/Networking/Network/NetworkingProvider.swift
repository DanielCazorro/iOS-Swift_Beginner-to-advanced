...
final class NetworkingProvider {
    ...
    func updateUser(id: Int, user: NewUser, success: @escaping (_ user: User) -> (), failures: @escaping (_ error: Error?) -> ()) {
    ...
    func deleteUser(id: Int, success: @escaping () -> (), failures: @escaping (_ error: Error?) -> ()) {
